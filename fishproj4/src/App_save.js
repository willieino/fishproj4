...
class App extends Component {
  ...
  viewTable = (e) => {
    e.preventDefault();
    localStorage.setItem('viewTrip', 'ViewTable');
    // console.log("e.target.value:", e.target.value)
    //  this.setState({ [e.target.name]: e.target.value });
  ...
  viewTripForm = (e) => {
    e.preventDefault();
    localStorage.setItem('viewTrip', 'TripFrm');
    // console.log("e.target.value:", e.target.value)
    //  this.setState({ [e.target.name]: e.target.value });
    //this.setState = ({ viewTrip: false, enterTrip: true });
  ...
  viewTripData = (e) => {
    e.preventDefault();
    localStorage.setItem('viewTrip', 'TripData');
  ...
  render() {
    ...
    const viewIt = localStorage.getItem('viewTrip')
    switch (viewIt) {
    ...
    /*   case "ViewTable":
        return <div className="App">
          ...
          <div className="main-container"><NavLeft />
            <div className="main-display"><TableDisplay viewTable={this.viewTable} handleSubmit={this.handleSubmit} TripTbl={this.state.TripTbl} key={this.ID} Trip={this.props.Trip} StartDate={this.props.StartDate} Duration={this.props.Duration}
              changeHandler={this.changeHandler} Place={this.props.Place} Photos={this.props.Photos} Notes={this.props.Notes} Anglers={this.props.Anglers} Gps1={this.props.GPS1} Gps2={this.props.GPS2} ImgCaption={this.props.ImgCaption} /></div></div> </div>;
 */
